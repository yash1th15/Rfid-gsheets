...
//-----------------------------------------------------------------------------------
#define FIREBASE_HOST "gps-system-345412-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "BG4jphS9IjplcP2wLKhPaMsUEnMDezgkCZV3FoLX"
#define WIFI_SSID "STIC_LMES"
#define WIFI_PASSWORD "STIC_LMES@000"
//-----------------------------------------------------------------------------------
